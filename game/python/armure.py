...
class CasqueEnCuire(Casque):
    def __init__(self,nom="Casque en cuir",description="Un casque en cuir basique, un indispensable pour les aventuriers en herbe soucieux de leur petit crâne délicat.",defence_physique=1, defence_magique=0):
        super().__init__(nom,description,defence_physique,defence_magique)
        defence_physique = 1

class CoiffeDerudi(Casque):
    def __init__(self,nom="Coiffe d'érudit",description="Coiffe de mage décerné uniquement aux magiciens s'étant illustré dans une bataille épique.",defence_physique=0,defence_magique=1):
        super().__init__(nom,description,defence_physique,defence_magique)
        defence_magique = 1
...
class ArmureEnCuire(Plastron):
    def __init__(self,nom="Plastron en cuir",description="Un bon plastron qui vous protégera à coup sûr de certaines attaques (faites attention quand même)",defence_physique=2, defence_magique=0):
        super().__init__(nom,description,defence_physique, defence_magique)
        defence_physique = 2
